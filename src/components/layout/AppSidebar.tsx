    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="min-w-[220px]">
        ...
        <DropdownMenuItem asChild>
          <NavLink to="/setup?manage=1" className="cursor-pointer">
...
function Brand() {
  // Deploy nichado: o cliente é fixo. O nome vem do .env (VITE_CLIENT_NAME),
  // então o mesmo código serve para especializar em qualquer cliente.
  const client = (import.meta.env.VITE_CLIENT_NAME as string) || "";
  return (
    <NavLink
      to="/dashboard"
      className="flex items-center gap-2"
      aria-label={client ? `Domani.AI — ${client}` : "Domani.AI"}
    >
