...
> ⚠️ Este é um deploy ESPECIALIZADO da plataforma Domani, dedicado a UM cliente:
> a Mamma Jamma. Mesma engine do Social Hub; a diferença é que abre já dentro da
> organização Mamma Jamma, com a marca pré-carregada, e toda IA usa o contexto
> do cliente em `supabase/functions/_shared/client-context.ts`.
> Base de conhecimento do cliente: `knowledge/mamma-jamma/`.
> Setup do cliente: `docs/SETUP-MAMMA-JAMMA.sql`.
